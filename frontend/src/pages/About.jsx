...
const About = () => {
  return (
    <div className="about-page">
      {/* 1. Hero Section */}
      <section style={{ display: 'flex', padding: '80px 10%', backgroundColor: '#fcfbf8', alignItems: 'center' }}>
        <div style={{ flex: 1, paddingRight: '50px' }}>
          ...
          <h1 style={{ fontSize: '3.5rem', fontFamily: 'var(--font-heading)', color: '#3c2d24', marginBottom: '20px', lineHeight: '1.1' }}>A Bridal & Designer Boutique Built on Craftsmanship, Fit & Trust</h1>
        ...
        <div style={{ flex: 1 }}>
          <img src={img1} alt="Bridal Design" style={{ width: '100%', borderRadius: '16px', objectFit: 'cover', height: '600px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }} />
        </div>
      </section>

      {/* 2. Chief Designer Section */}
      <section style={{ padding: '60px 10%', backgroundColor: '#fcfbf8' }}>
        <div style={{ backgroundColor: '#3c2d24', borderRadius: '24px', padding: '50px', display: 'flex', color: 'white', gap: '50px', position: 'relative', zIndex: 2 }}>
          <div style={{ flex: 1, position: 'relative' }}>
             <img src={img8} alt="Shruthi Ajith" style={{ width: '100%', borderRadius: '16px', objectFit: 'cover', height: '100%' }} />
          ...
          <div style={{ flex: 1.5, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
             ...
             <h2 style={{ fontSize: '3rem', fontFamily: 'var(--font-heading)', marginBottom: '5px' }}>Shruthi Ajith</h2>
        ...
        {/* Stats Row */}
        <div style={{ display: 'flex', backgroundColor: '#1a140f', borderRadius: '0 0 24px 24px', padding: '30px 50px', marginTop: '-20px', paddingTop: '40px', color: 'white', justifyContent: 'space-between', position: 'relative', zIndex: 1 }}>
           <div><h3 style={{ fontSize: '2rem', color: '#cba153', marginBottom: '5px' }}>250+</h3><p style={{ fontSize: '0.9rem', margin: 0, color: '#a39c94' }}>Brides Styled</p></div>
           <div><h3 style={{ fontSize: '2rem', color: '#cba153', marginBottom: '5px' }}>10+</h3><p style={{ fontSize: '0.9rem', margin: 0, color: '#a39c94' }}>Years of Experience</p></div>
           <div><h3 style={{ fontSize: '2rem', color: '#cba153', marginBottom: '5px' }}>5.0</h3><p style={{ fontSize: '0.9rem', margin: 0, color: '#a39c94' }}>Google Rating</p></div>
        </div>
      </section>

      {/* 3. Why Choose Us */}
      <section style={{ padding: '80px 10%', backgroundColor: '#e5e0d8' }}>
        <p style={{ color: '#cba153', fontSize: '0.8rem', letterSpacing: '2px', textAlign: 'center', marginBottom: '10px' }}>WHY CHOOSE US</p>
        <h2 style={{ fontSize: '2.5rem', fontFamily: 'var(--font-heading)', color: '#3c2d24', textAlign: 'center', marginBottom: '15px' }}>Why Brides Choose Hinaaz</h2>
        ...
        <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
          {[
            ...
            "On-time delivery & prompt support"
             ...
             <div key={i} style={{ backgroundColor: 'white', padding: '30px 20px', borderRadius: '16px', flex: '1', minWidth: '180px', textAlign: 'center', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
      ...
      {/* 4. How We Work */}
      <section style={{ padding: '80px 10%', backgroundColor: '#fcfbf8' }}>
        <p style={{ color: '#cba153', fontSize: '0.8rem', letterSpacing: '2px', textAlign: 'center', marginBottom: '10px' }}>HOW WE WORK</p>
        <h2 style={{ fontSize: '2.5rem', fontFamily: 'var(--font-heading)', color: '#3c2d24', textAlign: 'center', marginBottom: '50px' }}>Our Approach to Every Design</h2>
        
        <div style={{ display: 'flex', gap: '30px' }}>
           <div style={{ flex: 1, backgroundColor: 'white', padding: '50px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={{ padding: '80px 10%', backgroundColor: '#e5e0d8' }}>
        ...
        <h2 style={{ fontSize: '2.5rem', fontFamily: 'var(--font-heading)', color: '#3c2d24', textAlign: 'center', marginBottom: '50px' }}>Trusted by Brides Across Bangalore</h2>
        
        <div style={{ backgroundColor: 'white', padding: '50px', borderRadius: '24px', maxWidth: '1000px', margin: '0 auto', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
           <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f4efea', paddingBottom: '30px', marginBottom: '30px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                 <div style={{ fontSize: '3rem', fontWeight: 'bold', color: '#3c2d24', lineHeight: '1' }}>5.0</div>
                 <div>
           ...
           <div style={{ display: 'flex', gap: '30px' }}>
              {[1, 2, 3].map((r) => (
                 <div key={r} style={{ flex: 1, padding: '30px', border: '1px solid #f4efea', borderRadius: '16px', backgroundColor: '#fcfbf8' }}>
      ...
      {/* 6. CTA Banner */}
      <section style={{ backgroundColor: '#3c2d24', color: 'white', padding: '60px 10%', textAlign: 'center', margin: '60px 10%', borderRadius: '24px' }}>
         <p style={{ color: '#cba153', fontSize: '0.8rem', letterSpacing: '2px', marginBottom: '15px' }}>START YOUR DESIGN JOURNEY</p>
         <h2 style={{ fontSize: '2.2rem', marginBottom: '30px', fontFamily: 'var(--font-heading)', maxWidth: '800px', margin: '0 auto 30px' }}>Share your requirements with us. Book a personal consultation with our chief designer today.</h2>
