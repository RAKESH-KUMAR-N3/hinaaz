...
const Contact = () => {
  return (
    <div className="contact-page" style={{ backgroundColor: '#f4efea', minHeight: '80vh', padding: '60px 0' }}>
      <div className="container">
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px' }}>
          
          {/* Left Column */}
          <div style={{ flex: '1', minWidth: '300px', backgroundColor: 'white', padding: '50px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            <p style={{ letterSpacing: '2px', fontSize: '0.8rem', fontWeight: 'bold', marginBottom: '20px', color: '#5c4e46' }}>CONTACT</p>
            <h1 style={{ fontSize: '2.5rem', marginBottom: '20px', lineHeight: '1.2' }}>Start Your Bridal and Designer Outfit Consultation</h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div style={{ border: '1px solid #e5e0d8', padding: '20px', borderRadius: '12px' }}>
                ...
                <p style={{ fontWeight: '500' }}>Shrusara Fashion Boutique, 106, 6th Main Road, Mahalakshmipuram, Bangalore - 560086</p>
              </div>
              <div style={{ border: '1px solid #e5e0d8', padding: '20px', borderRadius: '12px' }}>
              ...
              <div style={{ border: '1px solid #e5e0d8', padding: '20px', borderRadius: '12px' }}>
                ...
                <p style={{ fontWeight: '500' }}>help@shrusara.com</p>
              </div>
            </div>
          </div>
          ...
          <div style={{ flex: '1', minWidth: '300px', backgroundColor: 'white', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', overflow: 'hidden' }}>
             <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.481541885994!2d77.5459!3d13.0049!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3d8d6411d33d%3A0xc3c5443e0e71cb!2sShrusara%20Fashion%20Boutique!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" 
               width="100%" 
               height="100%" 
